...
const getImage = type =>{
    switch(type){
        case 'moto_motorcycle': return bike;
        case 'veh_passenger': return car;
        case 'bus_bus': return bus;
        case 'client':return ClientImg;
        default: return car;
    }
}
...
const marker = (props) => {
    const {text, type = 'bike', $hover, angle} = props;
